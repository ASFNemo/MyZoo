...
public class Elephant extends Animal {
    ...
    /**
     *
     * The Elephant constructor actually creates a blue print of a Elephant.
     *
     * the constructor for the Elepahnt takes in parameter such as the health, enclosure and gender of the animal. some
     ...
     */
    public Elephant(int animalAge, char animalGender, int animalHealth, Enclosure thisAnimalsEnclosure) {
        super(animalAge, 36, new String[]{"hay", "fruit"}, animalGender, animalHealth, thisAnimalsEnclosure);
    ...
    public boolean aMonthPasses(){
        ...
        System.out.println("elephant a month apses");
        String foodEaten = "";
        decreaseHealth();
        decreaseHealth();
        increaseAge();
    ...
    /**
     * if this method is called the animal is treated. in this case it means that the Elephant gets a bath.
     */
    public void treat() {
        bath();
    }
    ...
    /**
     * when this method is called because the animal is treated then its health goes up by 5.
     */
    public void bath(){
        setHealth(getHealth() +5);
    }
